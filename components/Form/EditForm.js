...
export default function EditForm({ position, data }) {
	...
	const { register, handleSubmit, formState } = useForm({
		...
		defaultValues: {
			...
			seat_amount: restaurant.seat_amount,
		},
	});
	...
	const create = async (data) => {
		...
		try {
			const record = await pb.collection("restaurants").update(restaurant.id, formData);
